...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter_type in string.ascii_lowercase, string.ascii_uppercase:
            
            for i in range(len(letter_type)):
                try:
                    shift_dict[letter_type[i]] = letter_type[i + shift]
                except:
                    shift_dict[letter_type[i]] = letter_type[i + shift - len(letter_type)]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(27):
            ...
            if num_valid_words > best_shift_valid_words:
                best_shift, best_shift_valid_words = i, num_valid_words
