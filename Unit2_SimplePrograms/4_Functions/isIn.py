# -*- coding: utf-8 -*-
"""
Created on Wed Sep 15 21:30:51 2021
...
def isIn(char, aStr):
    ...
    if char == middle:
        ...
        if char < middle:
            return isIn(char, aStr[0 : aStr.index(middle)])
        else:
            return isIn(char, aStr[aStr.index(middle) + 1 :])
            
            
print(isIn('z', 'egghmooqstx'))
print(isIn('q', 'bbcdefijkkkmnnqquxx'))
